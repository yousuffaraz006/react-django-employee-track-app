...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.failure]:border-muted/40 group-[.failure]:hover:border-destructive/30 group-[.failure]:hover:bg-destructive group-[.failure]:hover:text-destructive-foreground group-[.failure]:focus:ring-destructive",
      className
    )}
    {...props} />
))
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.failure]:text-red-300 group-[.failure]:hover:text-red-50 group-[.failure]:focus:ring-red-400 group-[.failure]:focus:ring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}>
